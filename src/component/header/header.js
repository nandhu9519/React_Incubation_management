    ...
    if(storageExist.admin){
      return(
        <Navbar collapseOnSelect expand="lg" bg="dark" bg="primary" variant="dark">
            <Container fluid>
              <Navbar.Brand style={{cursor:"pointer",fontSize:"25px"}} onClick={()=>{navigate('/adminHome')}}>INCUBATOR.admin</Navbar.Brand>
      ...
      return (
        <div>
          <Navbar collapseOnSelect expand="lg" bg="dark" bg="primary" variant="dark">
            <Container fluid>
              <Navbar.Brand style={{cursor:"pointer",fontSize:"25px"}} onClick={()=>{navigate('/home')}}>INCUBATOR</Navbar.Brand>
